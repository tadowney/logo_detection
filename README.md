...
### **Custom Dataset made using Google Vision**
...
We set the threshold at 0.5, meaning that an IoU of > 0.5 was considered a hit, otherwise it was a fail. Each hit is recorded and then the average precision for class c is calculated with the following formula below such that TP is a True Positive and FP is a False Positive
<p align="center">
